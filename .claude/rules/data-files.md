...
- Product data fixtures and pipeline inputs must document source, schema version, ownership, and retention assumptions.
- Generated data artifacts must state whether they are checked in, reproducible, or build-only outputs.
- Data pipeline changes must include fixture-based tests for valid input, malformed input, and boundary cases.
