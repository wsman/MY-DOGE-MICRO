...
This module is the canonical home for provider-agnostic tool helpers. It lives
under ``doge.shared`` so product/tool providers (``doge.products.*``) can import
it without depending on ``doge.application`` (which would create a cycle).
"""
