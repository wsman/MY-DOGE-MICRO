...
def build_tool_application_service(
    ...
    return ToolApplicationService(
        ...
        portfolio_service_factory=lambda: build_portfolio_service(workspace_container_fn),
        risk_service_factory=lambda: build_risk_service(workspace_container_fn),
        scenario_service_factory=lambda: build_scenario_service(workspace_container_fn),
        rag_service_factory=lambda: build_rag_service_fn(db_path, runtime_container_fn),
        note_repository_factory=build_note_repository,
        industry_report_use_case_factory=build_generate_industry_report_use_case_fn,
        financial_statement_repository_factory=lambda: build_financial_statement_repository(),
        company_announcement_repository_factory=lambda: build_company_announcement_repository(),
        ...
        view_repository_factory=lambda: build_view_service(),
