...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_slots_bundle = slots_sub.add_parser("bundle", help="list, activate, or deactivate slot bundles")
    ...
    p_slots_bundle_deactivate = slots_bundle_sub.add_parser("deactivate", help="deactivate the active slot bundle")
    p_slots_bundle_deactivate.add_argument("--json", action="store_true")
