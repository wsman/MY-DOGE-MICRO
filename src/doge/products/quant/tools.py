...
Canonical quant tool execution provider (implementation lives here; `doge.application.capabilities.quant_provider` re-exports for compatibility).
"""
...
from doge.shared.tool_utils import (
    ServiceFactory,
    looks_mutating_sql,
    resolve,
)
...
from doge.core.ports.code_executor import (
    DisabledCodeExecutor,
    ExecutionResult,
    ICodeExecutor,
)
from doge.core.ports.market_view import IMarketViewRepository  # noqa: F401 (re-exported for doge.products.quant)
from doge.core.services.view_service import ViewService  # noqa: F401 (re-exported for doge.products.quant)
