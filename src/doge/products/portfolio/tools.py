...
Canonical portfolio tool execution provider (implementation lives here; `doge.application.capabilities.portfolio_provider` re-exports for compatibility).
"""
...
from doge.shared.tool_utils import ServiceFactory, resolve
