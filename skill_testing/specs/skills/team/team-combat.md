...
- [ ] Phase 2 includes spawning the primary engine specialist (read from `standards/technical-preferences.md`)
...
- Engine is configured in `standards/technical-preferences.md` (Engine Specialists section filled)
- No existing GDD for the requested combat feature

**Input:** `/team-combat parry and riposte system`

**Expected behavior:**
1. Phase 1 — game-designer spawned; produces `design/cdd/parry-riposte.md` covering all 8 required sections (overview, player fantasy, rules, formulas, edge cases, dependencies, tuning knobs, acceptance criteria); asks user to approve design doc
...
**Fixture:**
- `design/cdd/parry-riposte.md` exists (Phase 1 already complete)
...
**Fixture:**
- `design/cdd/parry-riposte.md` exists and is complete
...
**Fixture:**
- `standards/technical-preferences.md` has Engine Specialists section populated (e.g., Primary: godot-specialist)
...
2. Skill reads `standards/technical-preferences.md` Engine Specialists section to identify the primary engine specialist agent type
...
**Assertions:**
- [ ] Engine specialist agent type is read from `standards/technical-preferences.md` — not hardcoded
