...
`design/module-index.md` after user approval.
...
skipped. The skill writes to `design/module-index.md`.
...
- [ ] Contains "May I write" collaborative protocol language (for module-index.md)
...
and before `design/module-index.md` is written.
...
**Fixture:**
- `design/cdd/game-concept.md` exists with Core Mechanics and MVP Definition sections
- `design/cdd/game-pillars.md` exists with ≥1 pillar defined
- No `design/module-index.md` exists yet
...
5. Asks "May I write `design/module-index.md`?"
6. Writes module-index.md after approval
...
- [ ] "May I write `design/module-index.md`?" is asked before writing
- [ ] module-index.md is NOT written without approval
...
- [ ] Skill does NOT auto-write module-index.md while CONCERNS are unresolved
- [ ] User is given the option to revise or proceed
- [ ] Revised systems list is re-shown after revision before final "May I write"

---

### Case 4: Edge Case — module-index.md already exists

**Fixture:**
- `design/cdd/game-concept.md` exists
- `design/module-index.md` already exists with N systems

**Input:** `/map-systems`

**Expected behavior:**
1. Skill reads the existing module-index.md and presents its current state
2. Skill asks: "module-index.md already exists with [N] systems. Update with new systems, or review and revise priorities?"
3. User chooses an action
4. Skill does NOT silently overwrite the existing index

**Assertions:**
- [ ] Skill detects and reads the existing module-index.md before proceeding
...
- [ ] module-index.md is written after user approval
...
- [ ] "May I write `design/module-index.md`?" asked before writing
- [ ] module-index.md is NOT written without user approval
