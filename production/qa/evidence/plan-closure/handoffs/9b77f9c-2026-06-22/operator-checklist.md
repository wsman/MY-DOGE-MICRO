...
|----|----|----|----|----|
| S017-002 | passed | `env:DOGE_LIVE_KIMI=1`<br>`env:MOONSHOT_API_KEY`<br>`env:DOGE_LIVE_KIMI_AGENT_SDK=1`<br>`env:KIMI_FILES_API_CAPABLE=1`<br>`optional:env:DOGE_LIVE_KIMI_VISION_IMAGE` | `production/qa/evidence/live/kimi-live-smoke-2026-06-22.json` | `.\.venv\Scripts\python.exe scripts\validate_kimi_live_smoke_evidence.py production/qa/evidence/live/kimi-live-smoke-2026-06-22.json` |
