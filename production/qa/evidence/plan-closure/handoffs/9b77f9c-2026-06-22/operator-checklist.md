...
|----|----|----|----|----|
| S017-002 | passed | `env:DOGE_LIVE_KIMI=1`<br>`env:MOONSHOT_API_KEY`<br>`optional:env:DOGE_LIVE_KIMI_VISION_IMAGE`<br>`optional:env:DOGE_LIVE_KIMI_AGENT_SDK=1` | `production/qa/evidence/live/kimi-live-smoke-2026-06-22.json` | `.\.venv\Scripts\python.exe scripts\validate_kimi_live_smoke_evidence.py production/qa/evidence/live/kimi-live-smoke-2026-06-22.json` |
