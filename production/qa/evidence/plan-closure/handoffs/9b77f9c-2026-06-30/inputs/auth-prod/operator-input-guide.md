...
- Completed evidence belongs in: `production/qa/evidence/enterprise/enterprise-production-validation-2026-06-30.json`
- Strict validator: `.\.venv\Scripts\python.exe scripts\validate_enterprise_production_validation_evidence.py production/qa/evidence/enterprise/enterprise-production-validation-2026-06-30.json`
