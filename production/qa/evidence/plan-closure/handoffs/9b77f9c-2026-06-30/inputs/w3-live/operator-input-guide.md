...
- Completed evidence belongs in: `production/qa/evidence/eval/analyst-benchmark-2026-06-30.json`
- Strict validator: `.\.venv\Scripts\python.exe scripts\validate_analyst_benchmark_evidence.py production/qa/evidence/eval/analyst-benchmark-2026-06-30.json`
