...
> **Last Updated**: [Date]
> **Links To**: `design/cdd/game-concept.md`
> **Relevant CDDs**: [e.g., `design/cdd/combat.md`, `design/cdd/progression.md`]
...
> tune the whole-game difficulty curve without hunting through individual CDDs.
> For each lever, the CDD that owns it should be cross-referenced.
>
