...
<!-- This section is MANDATORY. Every ADR must trace back to at least one CDD
     requirement, or explicitly state it is a foundational decision with no CDD
     dependency. Traceability is audited by /architecture-review. -->

| CDD Document | System | Requirement | How This ADR Satisfies It |
|-------------|--------|-------------|--------------------------|
| [e.g. `design/cdd/combat.md`] | [e.g. Combat] | [e.g. "Hitbox detection must resolve within 1 frame"] | [e.g. "Jolt physics collision queries run synchronously in _physics_process"] |

> If this is a foundational decision with no direct CDD dependency, write:
> "Foundational — no CDD requirement. Enables: [list what CDD systems this
