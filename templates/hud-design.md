...
> **Related CDDs**: [Every system that exposes information through the HUD — e.g., `design/cdd/combat.md`, `design/cdd/progression.md`, `design/cdd/quests.md`]
> **Accessibility Tier**: Basic | Standard | Comprehensive | Exemplary
> **Style Reference**: [Link to art bible HUD section if it exists — e.g., `design/cdd/art-bible.md § HUD Visual Language`]
...
|----------|-------|----------|-----------|
| [e.g., Should the minimap show enemy positions by default, or only after a detection skill is unlocked?] | [systems-designer + ui-designer] | [Sprint 5, Day 2] | [Pending — depends on progression CDD decision] |
