...
> **Created**: [Date]
> **Last Updated**: [Date]
> **Source Concept**: design/cdd/game-concept.md
...
|---|-------------|----------|----------|--------|------------|------------|
| 1 | [e.g., Player Controller] | Core | MVP | [Not Started / In Design / In Review / Approved / Implemented] | [design/cdd/player-controller.md or "—"] | [e.g., Input System, Physics] |
...
order. Each system's CDD should be completed and reviewed before starting the
...
A "session" is one focused design conversation producing a complete CDD.]
