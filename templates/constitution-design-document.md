...
20 CDDs uses this section to decide whether to read further. No jargon.]
...
[Declare every explicit dependency on another CDD's specific mechanic, value, or
...
| This Document References | Target CDD | Specific Element Referenced | Nature |
|--------------------------|-----------|----------------------------|--------|
