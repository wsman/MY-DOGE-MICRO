---
name: security-audit
description: "Audit security vulnerabilities. Game: save tampering, cheat vectors, network exploits, player data, input validation. Product: OWASP/API auth, sessions, secrets, authorization boundaries, privacy, logging, rate limiting, and deployment configuration."
