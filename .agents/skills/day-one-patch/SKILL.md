---
name: day-one-patch
description: "Prepare an immediate launch patch. Game: day-one patch after gold master or public launch. Product: post-release hotfix, rollback, migration repair, API/CLI packaging fix, config correction, or customer-facing patch."
...
- `design/cdd/game-concept.md` -> **[Game]** keep day-one patch planning for player-facing fixes, certification issues, critical playtest bugs, save fixes, and platform build issues.
- `design/cdd/product-concept.md` -> **[Product]** plan an immediate post-release patch: rollback, hotfix, migration repair, API compatibility fix, CLI packaging fix, config correction, docs correction, and customer/user communication.
- If unclear, ask whether the patch is for a shipped game build or a product/service release.

Preserve game day-one patch guidance. Product hotfix guidance is parallel.
# Day-One Patch
