...
allowed-tools: Bash(doge rsrs *)
---

## User Guide

- When to use: Use `/rsrs` when the operator wants momentum ranking,
  strong-trend candidates, or a quick scan of leading names by market.
- Inputs: Optional `--market cn|us` and `--top N` arguments.
- Outputs: RSRS ranking table plus a brief summary of strongest names and
