...
- `stock` 子命令：`src/doge/interfaces/cli/main.py:53-56`
- `rsrs` 子命令：`src/doge/interfaces/cli/main.py:59-61`
- `breadth` 子命令：`src/doge/interfaces/cli/main.py:64-66`
- `anomaly` 子命令：`src/doge/interfaces/cli/main.py:69-71`
- `demo` 子命令：`src/doge/interfaces/cli/main.py:74-76`
- 命令分发（`main()`）：`src/doge/interfaces/cli/main.py:86-102`
...
查询输出始终面向终端，**无 JSON / CSV 输出开关**；脚本化解析建议改用 MCP 工具（见 [docs/MCP_SERVER.md](MCP_SERVER.md)）或 FastAPI 端点（见 `docs/API.md`）。`doctor`、`run`、`session`、`case`、`template` 等运维/agent 命令可按各自参数输出 JSON 或 JSONL。
