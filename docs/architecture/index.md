...
ADR-0068). It is governed by feature flags, with controlled built-in facets
...
[ADR-0068](adr-0068-slot-eval-suite-provider-facet.md), and operational flag details in
