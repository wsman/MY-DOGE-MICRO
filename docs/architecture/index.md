...
ADR-0072). It is governed by feature flags, with controlled built-in facets
...
[ADR-0070](adr-0070-slot-watcher-provider-facet.md),
[ADR-0071](adr-0071-slot-governance-policy-provider-facet.md),
[ADR-0072](adr-0072-slot-gateway-route-provider-facet.md), and operational flag details in
