...
ADR-0071). It is governed by feature flags, with controlled built-in facets
...
[ADR-0071](adr-0071-slot-governance-policy-provider-facet.md), and operational flag details in
