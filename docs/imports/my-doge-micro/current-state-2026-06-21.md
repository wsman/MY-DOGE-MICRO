...
|------|---------------|----------|
| Product entry docs | Root README remains product-focused and points to the operational docs. API count is 76 product routes after the platformization route additions, while new surfaces remain feature-flagged. CLI recommendation is `doge ...`. | `README.md`, `docs/API.md`, `docs/CLI.md`, `docs/GETTING_STARTED.md` |
