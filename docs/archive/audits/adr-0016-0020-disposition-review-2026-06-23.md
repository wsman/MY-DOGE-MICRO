...
| ADR-0020 | Proposed | `web/src/config/features.ts`, `web/src/router/index.ts`, `web/src/App.vue`, platform views/stores, `web/README.md`, `production/qa/evidence/manual/case-workspace-browser-smoke-2026-06-23.json`, `production/qa/evidence/manual/case-workspace-ax-tree-2026-06-24.json`, and `production/qa/evidence/manual/platform-shell-default-entry-smoke-2026-06-24.json` preserve `/research-agent`, make `/home` the default local Web entry, and retain `VITE_DOGE_FEATURE_PLATFORM_SHELL=0` rollback. | Dependent ADRs 0016-0019 are still Proposed, broader external closure gates remain open, and exact-SHA remote CI for the defaultization work is not yet collected. |
