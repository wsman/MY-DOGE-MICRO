...
11. AGENT WRITES FILE
    Agent: [Uses Write tool]
           "Created design/cdd/crafting-system.md. Would you like me to run
...
Agent: [Writes design/cdd/combat-system.md with full design]
...
Agent: "Ready to write to design/cdd/combat-system.md?"
User: "Yes"
Agent: [Writes file]
```
...
✅ RIGHT:
User: "Implement damage calculation per design/cdd/combat-system.md"
